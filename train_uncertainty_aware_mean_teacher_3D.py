...
parser.add_argument('--root_path', type=str,
                    default='D:/qinchendong/SSL4MIS_master/data/BraTS2019', help='Name of Experiment')
...
parser.add_argument('--labeled_num', type=int, default=37,
                    help='labeled data')
# costs
...
def train(args, snapshot_path):
    ...
    unlabeled_idxs = list(range(args.labeled_num, 100))
