...
def test_all_case(net, base_dir, test_list="full_test.list", num_classes=2, patch_size=(48, 160, 160), stride_xy=32, stride_z=24):
    ...
    for image_path in tqdm(image_list):
        h5f = h5py.File(image_path, 'r')#----------------------todo--------------------修改数据集-------------------------
        image = h5f['image'][:]
        label = h5f['label'][:]
