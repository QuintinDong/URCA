...
from networks.unet import UNet, UNet_DS, UNet_URPC, UNet_CCT,UNet2
import argparse
from networks.vision_transformer import SwinUnet as ViT_seg
from networks.config_1 import get_config
...
parser.add_argument(
    '--cfg', type=str, default=r"D:/qinchendong/SSL4MIS_master/code/configs/swin_tiny_patch4_window7_224_lite.yaml", help='path to config file', )#--------todo----------
parser.add_argument(
    "--opts",
...
def net_factory(net_type="unet", in_chns=1, class_num=3):
    if net_type == "unet":
        ...
        net = UNet2(in_chns=in_chns, class_num=class_num).cuda()
    else:
        net = None
    return net
