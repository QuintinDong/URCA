...
class Encoder(nn.Module):
    ...
    def forward(self, x):
        x0 = self.in_conv(x)
        #print(x0.shape)#torch.Size([24, 16, 256, 256])
        x1 = self.down1(x0)
        #print(x1.shape)#torch.Size([24, 32, 128, 128])
        x2 = self.down2(x1)
        #print(x2.shape)#torch.Size([24, 64, 64, 64])
        x3 = self.down3(x2)
        #print(x3.shape)#torch.Size([24, 128, 32, 32])
        x4 = self.down4(x3)
