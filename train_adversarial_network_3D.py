...
parser.add_argument('--root_path', type=str,
                    default=r'D:/qinchendong/SSL4MIS_master/data/changhai', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='changhai_hosptial_Adversarial_Network', help='experiment_name')
...
parser.add_argument('--labeled_num', type=int, default=27,
                    help='labeled data')
# costs
...
def train(args, snapshot_path):
    ...
    unlabeled_idxs = list(range(args.labeled_num, 134))#------------todo---------------data_range----------------------
    batch_sampler = TwoStreamBatchSampler(
        labeled_idxs, unlabeled_idxs, batch_size, batch_size-args.labeled_bs)

    trainloader = DataLoader(db_train, batch_sampler=batch_sampler,
                             num_workers=0, pin_memory=True, worker_init_fn=worker_init_fn)#-----------todo--------num_workers=0----------
