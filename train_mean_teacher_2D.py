    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                writer.add_scalar('info/val_mean_dice', performance_ema, iter_num)
                writer.add_scalar('info/val_mean_hd95', mean_hd95_ema, iter_num)
                ...
                logging.info(
                    'iteration %d : mean_dice_ema : %f mean_hd95_eam : %f' % (iter_num, performance_ema, mean_hd95_ema))
                model.train()
