...
parser.add_argument('--root_path', type=str,
                    default='D:/qinchendong/Pancreas/pancreas', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='Regularized_Dropout_pancreas', help='experiment_name')
...
parser.add_argument('--labeled_num', type=int, default=44,
                    help='labeled data')
parser.add_argument('--total_num', type=int, default=219,
                    help='total data')
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                avg_metric1 = test_all_case(
                    model1, args.root_path, test_list="val.txt", num_classes=3, patch_size=args.patch_size,
                ...
                avg_metric2 = test_all_case(
                    model2, args.root_path, test_list="val.txt", num_classes=3, patch_size=args.patch_size,
                    stride_xy=64, stride_z=64)
