...
parser.add_argument('--root_path', type=str,
                    default=r'D:/qinchendong/SSL4MIS_master/data/abdomain_CT_public', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='public_abdomain', help='experiment_name')
...
parser.add_argument('--labeled_num', type=int, default=23,
                    help='labeled data')
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                avg_metric1 = test_all_case(
                    model1, args.root_path, test_list="val.txt", num_classes=14, patch_size=args.patch_size,   #todo--------------num_classes------------
                ...
                avg_metric2 = test_all_case(
                    model2, args.root_path, test_list="val.txt", num_classes=14, patch_size=args.patch_size,
                    stride_xy=64, stride_z=64)
